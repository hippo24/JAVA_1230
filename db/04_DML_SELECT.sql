...
# 속성명 앞에 AS 새 속성명을 입력하면 결과창에 속성 이름을 변겨할 수 있음
# - AS 생략 가능
SELECT ST_GRADE AS 학년, ST_CLASS AS "반", ST_NUM 번호, ST_NAME FROM STUDENT;
...
# 비교 연산자
#  =, !=, <>, <, <=, >-
#  - 속성 BEETWEEN A AND B : A이상 B이하 => 속성 >= A AND 속성 <= B
...
# 1학년 1반에서 번호가 1번 ~ 3번 사이의 학생들을 조회하는 쿼리 
